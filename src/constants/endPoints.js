const EndPoints = Object.freeze({
  ...
  TRIP_HOTELS: (id) => `/trips/${id}/hotels`,
  TRIP_HOTEL: (tripId, id) => `/trips/${tripId}/hotels/${id}`,
  RESOLVE_MAP_LINK: "/maps/resolve-link",
  ...
  TRIP_ITINERARY_ITEM: (tripId, id) => `/trips/${tripId}/itinerary/${id}`,
  TRIP_ITINERARY_REORDER: (tripId) => `/trips/${tripId}/itinerary/reorder`,
  TRIP_SHARE_COLLECTIONS: (id) => `/trips/${id}/share-collections`,
  TRIP_SHARE_COLLECTION: (tripId, id) => `/trips/${tripId}/share-collections/${id}`,
